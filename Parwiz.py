...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; 8.0.0; SM-G960F Build/R16NW) (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36.{str(random.randint(100000, 900000))};]"
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; CPH1725 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/350.1.0.29.106.{str(random.randint(100000, 900000))};]"
	ua = f"Dalvik/2.1.0 (Linux; U; Android {versi_android}; S10-H Build/PQ3A.{str(random.randint(100000, 900000))};]"
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-A217F Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/309.0.0.16.{str(random.randint(100000, 900000))};]"
	ua = f"Dalvik/2.1.0 (Linux; U; Android 10; 706SH Build/S2005)"
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-A336E Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/309.0.0.16.{str(random.randint(100000, 900000))};]"
	if ua in ugen:pass
	else:ugen.append(ua)
logo=("""\033[1;37m
  .███ ██ ██ ██ ██ ███████ █████ █████ ██████ ████ ██ ██ ██ ██ ███ ██ ██ ██ ██ ██ ██ ██ ██ ██ ██ █████ ███ ███████ ███████ ██ ██ ██ ██ ██ ██ ██ ██ ███ ██ ██ ██ ██ ██ ██ ██ ████ ██ ██ ██ ███████ ██ ██ ██ ██ ██████
----------------------------------------------
 Author    : Parwiz 
 Github    : Parwiz Nikzaad
 Facebook  : Parwiz Nikzaad
 Tool Name : AKING_OPEN.py
 Type type : PREMIUM 
 Version   : 9.9.9.9.9
----------------------------------------------
 AKING Pro version 9.9.9.9.9
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        for user in id:
                                ...
                                if mthd in ['1','01']:
                                	    ...
                                	    crack_submit.sublit(rndm,ids,passlist)
                                else:
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SOLO_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-ope nhttps://www.facebook.com/profile.php?id=100076211978824/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+93784807317&text="
                        name = input(" Enter your Name :Parwiz ")
                        linex()
                        tks = ("Hi SOLO Sir, I Need To Buy Your Paid SOLO PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python aking-1.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
